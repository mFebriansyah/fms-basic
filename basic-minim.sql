...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 07, 2014 at 11:10 AM
...
--
-- Dumping data for table `fms_pr_module_category`
--

INSERT INTO `fms_pr_module_category` (`id_fms_pr_module_category`, `nama_kategori_module`) VALUES
(1, 'food enak');
...
--
-- Dumping data for table `fms_sm_module`
--

INSERT INTO `fms_sm_module` (`id_fms_sm_module`, `module_name`, `id_parent_module`, `table_name`, `id_fms_pr_module_category`, `img`) VALUES
(1, 'Restaurant', 0, 'fe_tc_restaurant', 1, NULL),
(3, 'Range Category', 1, 'fe_pr_restaurant_range_category', 1, NULL);
